...
case0.on_interaction = function ()
	if getPos(0) < 6 and continue then
...
case1.on_interaction = function ()
	if getPos(1) < 6 and continue then
...
case2.on_interaction = function ()
	if getPos(2) < 6 and continue then
...
case3.on_interaction = function ()
	if getPos(3) < 6 and continue then
...
case4.on_interaction = function ()
	if getPos(4) < 6 and continue then
...
case5.on_interaction = function ()
	if getPos(5) < 6 and continue then
...
case6.on_interaction = function ()
	if getPos(6) < 6 and continue then
...
function check_win(pam, posx, posy)
	-- body
	local mult = 1
	local res = 1
	local y
